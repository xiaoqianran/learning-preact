...
/** Preact 课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "preact-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "preact-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Mauve，贴合 Preact 品牌色 */
export const DEFAULT_CTP_ACCENT: CtpAccent = "mauve";
