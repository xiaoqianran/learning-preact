...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Preact 实战学习 · 系统路径",
      },
      {
        name: "description",
        content:
          "Preact 中文交互教程：清晰学习路径、文档地图、讲解+源码+Demo、Catppuccin 主题与全栈工坊。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('preact-learn-ctp-flavor');var a=localStorage.getItem('preact-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['green','mauve','blue','lavender','sapphire','teal','peach','pink'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='mauve';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','mauve');}})();";

function RootDocument({ children }: { children: ReactNode }) {
  return (
    <html lang="zh-CN" data-ctp-flavor="mocha" data-ctp-accent="mauve">
      <head>
